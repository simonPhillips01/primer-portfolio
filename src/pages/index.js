  ...
  <Layout>
          ...
          >
            ...
            >
              ...
              <LinkLight
                style={{ marginLeft: "8px" }}
                fontSize={[0, 1, 2]}
                href="https://www.linkedin.com/in/simon-phillips01/"
              >
                LinkedIn
              </LinkLight>{" "}
            </Text>
    ...
    <Body>
      ...
      <Box px={5} className="container-xl">
        <Flex mx={-5} flexWrap="nowrap" alignItems="start">
          ...
          <StyledFlex size={[1, 6 / 12, 6 / 12]} px={5} mb={[3, 4, 4, 2]}>
            ...
            <Flex.Item>
              <LinkLight
                style={{ marginBottom: "1.45rem" }}
                fontSize={2}
                href="https://github.com/simonPhillips01/Slack"
              >
                Slack clone
              </LinkLight>
              <Text as="p" color="blue.2" mb={5} fontSize={3}>
                A full stack chat application using React, Redux, Firebase and Semantic UI.
              </Text>
            </Flex.Item>
          </StyledFlex>
          <StyledFlex size={[1, 6 / 12, 6 / 12]} px={5} mb={[3, 4, 4, 2]}>
            ...
            <Flex.Item>
              <LinkLight
                style={{ marginBottom: "1.45rem" }}
                fontSize={2}
                href="https://github.com/simonPhillips01/cryptocurrency-dashboard"
              >
                Cryto-currency Dashboard
              </LinkLight>
              <Text as="p" color="blue.2" mb={5} fontSize={3}>
                A crypto currency comparison dashboard built with React, Context API, Styled components and CSS Grid.
              </Text>
            </Flex.Item>
          </StyledFlex>
      ...
      <Grid justifyContent="center">
        <Grid.Item style={{ margin: "auto" }}>
          ...
          <LinkDark
            ...
            mb={3}
            display="block"
            href="mailto:simon.phillips01@gmail.com"
          >
      ...
      <FooterBox color="black" px={5} mx="auto" className="container-xl">
        ...
        >
          ...
          <Text as="p" fontSize={2} fontWeight={500} mt={3}>
            &copy; Simon Phillips {new Date().getFullYear()}.
          </Text>
        </Box>
      </FooterBox>
    </Box>
